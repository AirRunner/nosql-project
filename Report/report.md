...
- [What is Redis? – AWS](https://aws.amazon.com/redis)
- [What users say about Redis? – TrustRadius](https://www.trustradius.com/compare-products/redis)
- [Cassandra vs Redis](https://www.educba.com/cassandra-vs-redis)
- [Countries API](https://restcountries.eu)
- [Commerces Dataset](https://opendata.paris.fr/explore/dataset/coronavirus-commercants-parisiens-livraison-a-domicile/information)